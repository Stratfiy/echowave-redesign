# Decibyl SDK Examples

Runnable examples of the Decibyl SDK in Python and TypeScript.
...
export DECIBYL_API_ENDPOINT=http://localhost:8000
export DECIBYL_API_TOKEN=sk-...
