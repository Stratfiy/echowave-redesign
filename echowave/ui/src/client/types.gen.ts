...
export type ClientOptions = {
    baseUrl: 'https://app.echowave.com' | 'http://localhost:8000' | (string & {});
};
 ...
 * EchoWave
 */
export type EchoWaveEmbeddingsConfiguration = {
    /**
     * Provider
     */
    provider?: 'echowave';
     ...
     * Model
     *
     * EchoWave-managed embedding model.
     */
    model?: string;
};
 ...
 * EchoWave
 */
export type EchoWaveLlmService = {
    /**
     * Provider
     */
    provider?: 'echowave';
     ...
     * Model
     *
     * EchoWave-hosted model tier.
     */
    model?: string;
};

/**
 * EchoWaveManagedAIModelConfiguration
 */
export type EchoWaveManagedAiModelConfiguration = {
    /**
     * Api Key
     */
    api_key: string;
 ...
 * EchoWave
 */
export type EchoWaveSttService = {
    /**
     * Provider
     */
    provider?: 'echowave';
 ...
 * EchoWave
 */
export type EchoWaveTtsService = {
    /**
     * Provider
     */
    provider?: 'echowave';
...
export type GoogleTtsConfiguration = {
     ...
     * Model
     *
     * Google Cloud low-latency TTS engine. EchoWave maps this to Pipecat's streaming Google TTS service for Chirp 3 HD and Journey voices.
     */
    model?: string;
    /**
     * Voice
...
export type HttpApiConfig = {
     ...
     * Preset Parameters
     *
     * Parameters injected by EchoWave from fixed values or workflow context templates.
     */
...
export type HttpTransferResolverConfig = {
     ...
     * Wait Message
     *
     * Optional short message played while EchoWave resolves routing.
     */
 ...
 * PresetToolParameter
 *
 * A parameter injected by EchoWave at runtime.
 */
