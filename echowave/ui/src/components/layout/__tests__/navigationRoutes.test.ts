...
describe("navigation routes", () => {
  it.each([['/tools/42', '/tools'], ['/integrations', '/tools'], ['/marketplace/integrations', '/marketplace'], ['/marketplace/tools', '/marketplace'], ['/integrations/apps', '/marketplace'], ['/numbers', '/telephony-configurations'], ['/verified-numbers', '/telephony-configurations'], ['/missed-calls', '/telephony-configurations'], ['/workflow/42', '/workflow'], ['/model-configurations', '/workflow'], ['/recordings', '/files'], ['/reports', '/usage'], ['/review', '/usage'], ['/analytics', '/usage'], ['/analytics/spend', '/usage'], ['/do-not-call', '/privacy'], ['/partner', '/billing'], ['/superadmin/partners', '/superadmin/partners']])("selects %s in %s", (path, expected) => {
  ...
  it("keeps every destination reachable, as a sidebar entry or as a tab under one", () => {
    ...
    for (const url of ['/overview','/workflow','/tools','/files','/contacts','/api-keys','/telephony-configurations','/campaigns','/deploy/connect','/deploy/web-widget','/usage','/billing','/privacy','/settings']) expect(urls).toContain(url);
