...
describe("navigation routes", () => {
  it.each([['/tools/42', '/integrations/apps'], ['/integrations', '/integrations/apps'], ['/numbers', '/telephony-configurations'], ['/verified-numbers', '/telephony-configurations'], ['/missed-calls', '/telephony-configurations'], ['/workflow/42', '/workflow'], ['/model-configurations', '/workflow'], ['/recordings', '/files'], ['/reports', '/usage'], ['/do-not-call', '/privacy'], ['/partner', '/billing'], ['/superadmin/partners', '/superadmin/partners']])("selects %s in %s", (path, expected) => {
