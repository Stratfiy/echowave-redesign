...
export async function impersonateAsSuperadmin(params: {
  ...
  // (served from the target sub-domain, e.g. app.decibyl.com). The route will set the
  ...
  // via NEXT_PUBLIC_APP_URL (e.g. https://app.decibyl.com); falls back to the current
