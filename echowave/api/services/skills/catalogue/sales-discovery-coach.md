...
description: Coaches sales teams on elite discovery methodology — question design,
...
emoji: 🔍
color: '#5C7CFA'
vibe: Asks one more question than everyone else — and that's the one that closes the
  deal.
---
