...
This module implements the telephony provider abstraction for Decibyl AI. For user-facing documentation, see the [Mintlify docs](https://docs.decibyl.ai/integrations/telephony/overview).
...
See the [Custom Provider Guide](https://docs.decibyl.ai/integrations/telephony/custom) in the documentation for detailed implementation instructions.
...
- [User Documentation](https://docs.decibyl.ai/integrations/telephony/overview)
- [Twilio Integration](https://docs.decibyl.ai/integrations/telephony/twilio)
- [Custom Providers](https://docs.decibyl.ai/integrations/telephony/custom)
- [Webhooks Guide](https://docs.decibyl.ai/integrations/telephony/webhooks)
