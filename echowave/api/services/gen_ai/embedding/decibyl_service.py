"""Decibyl-managed embedding service.

Routes embeddings through Decibyl's managed proxy (MPS). This mirrors the managed
voice services (``DecibylLLMService`` / ``DecibylTTSService``): when a server-minted
...
class DecibylEmbeddingService(OpenAIEmbeddingService):
    """OpenAI-compatible embedding client pointed at Decibyl's managed proxy."""
    ...
    def __init__(
        ...
        Args:
            ...
            api_key: Decibyl-managed MPS service key.
