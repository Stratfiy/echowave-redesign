...
Decibyl platform supports Deepgram, OpenAI, Google, Azure Speech, AssemblyAI, Speechmatics, Cartesia, Gladia, Sarvam, Smallest AI, Hugging Face, ElevenLabs, and Decibyl transcribers. You can take a look at the providers documentation of which language to select for your language requirements. 
...
Decibyl also supports Speaches, an OpenAI API-compatible server, so a transcription model you run yourself can be used in place of a provider.
