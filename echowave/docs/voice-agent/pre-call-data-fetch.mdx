...
| Field | Description |
| --- | --- |
| **Endpoint URL** | The URL Decibyl will send the POST request to. |
...
Decibyl sends a `POST` request with the following JSON payload:
...
```javascript
app.post("/decibyl/pre-call", async (req, res) => {
