...
Decibyl provides two categories of tools:
...
- [**Google Calendar**](/voice-agent/tools/google-calendar) — Create a real event on a connected Google Calendar, e.g. to book an appointment
