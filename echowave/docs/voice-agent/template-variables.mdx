...
<Screenshot
  src="template-variables.png"
  alt="The Template Variables panel in agent settings, showing a customer_name variable and the fields to add another"
  caption="Template Variables in agent settings. These are test values, not production data."
  shot="The Template Variables card in agent settings with one or two variables listed and the Add New Variable key/value fields below. Crop to the card — the old image included a 'Join Slack' button from the header."
/>
