---
title: "contacts.uploadUrl"
description: "A signed URL to upload a contacts file to, before importing it."
openapi: "POST /api/v1/s3/presigned-upload-url"
---

A signed URL to upload a contacts file to, before importing it.
...
curl -X POST https://api.decibyl.ai/api/v1/s3/presigned-upload-url \
