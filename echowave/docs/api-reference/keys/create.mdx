---
title: "keys.create"
description: "Create a key. The value is shown once."
openapi: "POST /api/v1/user/api-keys"
---

Create a key. The value is shown once.
...
```bash
curl -X POST https://api.decibyl.ai/api/v1/auth/login \
...
```bash
curl -X POST https://api.decibyl.ai/api/v1/user/api-keys \
