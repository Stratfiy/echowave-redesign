...
description: "Connect Decibyl to Paygent — real-time cost tracking, multimodal usage monitoring, and billing for voice agents"
---
...
Instead of building custom tracking infrastructure, you simply connect your Decibyl workflow to Paygent. As your agents handle calls, Decibyl passively calculates the exact multimodal token usage and audio duration. 
...
- A Decibyl voice agent workflow

## Setup

### 1. Create an agent and configure pricing in Paygent

Before connecting Decibyl, you must register your agent in Paygent and define how you want to charge your customers.
...
Next, set the **Indicator Name**. This is the billing event identifier you will pass from Decibyl (e.g. `per-minute-call`) to tell Paygent which rate to apply for this agent's calls:
...
Once your pricing is configured, confirm your setup. You will use the **Agent ID** and **Indicator** from this process to connect your Decibyl workflow.

### 2. Gather your Paygent credentials

You'll need three core values from your Paygent dashboard to link your Decibyl agent:
...
In your Decibyl workflow editor, click **Add node** and scroll to the **Integrations** section. Select **Paygent**. The node will appear on your canvas with a **Not configured** badge.
