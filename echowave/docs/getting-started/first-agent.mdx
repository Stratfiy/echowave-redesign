...
<Note>
Using the hosted platform, go to [app.decibyl.com](https://app.decibyl.com). Self-hosting locally? Use `http://localhost:3010` instead, and follow [Getting Started](/getting-started) first to get the platform running.
</Note>

## Step 1: Create an agent

Go to [app.decibyl.com/workflow](https://app.decibyl.com/workflow) and create a new agent.
