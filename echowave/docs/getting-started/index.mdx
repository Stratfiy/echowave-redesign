...
<Tip>
**Using an AI coding agent?** If you work in **Claude Code** or **Codex**, install the official Decibyl setup skill and let your agent handle installation, configuration, and troubleshooting for you. It orients to your OS, picks the right deploy path, runs Decibyl's own setup scripts, and verifies the result. Install it once:
...
Then start a new session and ask it to *"set up Decibyl"* (in Claude Code you can also run `/decibyl-setup`). See [decibyl-hq/decibyl-plugins](https://github.com/decibyl-hq/decibyl-plugins) for details.
</Tip>
