---
title: "Prerequisites"
description: "System requirements and setup needed to run Decibyl AI locally"
---
...
To run Decibyl AI locally, make sure you have the following installed:
...
Decibyl images are available from two registries:

- **GitHub Container Registry (Default)**: `ghcr.io/decibyl-hq` - Recommended for most users
- **Docker Hub**: `decibylai` - Alternative registry
...
REGISTRY=ghcr.io/decibyl-hq ./start_docker.sh

# Using Docker Hub
REGISTRY=decibylai ./start_docker.sh
```
```powershell Windows
# Using GitHub Container Registry (recommended)
$env:REGISTRY = 'ghcr.io/decibyl-hq'; .\start_docker.ps1

# Using Docker Hub
$env:REGISTRY = 'decibylai'; .\start_docker.ps1
```
</CodeGroup>
