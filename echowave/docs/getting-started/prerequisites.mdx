---
title: "Prerequisites"
description: "System requirements and setup needed to run EchoWave AI locally"
---
...
To run EchoWave AI locally, make sure you have the following installed:
...
EchoWave images are available from two registries:

- **GitHub Container Registry (Default)**: `ghcr.io/echowave-hq` - Recommended for most users
- **Docker Hub**: `echowaveai` - Alternative registry
...
REGISTRY=ghcr.io/echowave-hq ./start_docker.sh

# Using Docker Hub
REGISTRY=echowaveai ./start_docker.sh
```
```powershell Windows
# Using GitHub Container Registry (recommended)
$env:REGISTRY = 'ghcr.io/echowave-hq'; .\start_docker.ps1

# Using Docker Hub
$env:REGISTRY = 'echowaveai'; .\start_docker.ps1
```
</CodeGroup>
