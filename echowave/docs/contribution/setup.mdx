...
If these steps do not work for you, please open an issue on [GitHub](mailto:support@decibyl.com).
...
2. Push your branch to `origin` and open a pull request against `main`.
3. A maintainer reviews and merges.

Bug reports and feature ideas go through [GitHub Issues](mailto:support@decibyl.com). Issues tagged `good first issue` are a good place to start.
