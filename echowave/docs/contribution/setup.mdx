...
If these steps do not work for you, please open an issue on [GitHub](mailto:support@decibyl.ai).
...
Bug reports and feature ideas go through [GitHub Issues](mailto:support@decibyl.ai). Issues tagged `good first issue` are a good place to start.
