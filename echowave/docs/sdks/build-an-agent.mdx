...
description: "Assemble a EchoWave voice agent programmatically with the SDK and save it as a draft"
---
...
- An existing agent ID to save drafts against (create one in the EchoWave UI or via [`POST /api/v1/workflow/create`](/api-reference/agents/create-from-template))
...
<CodeGroup>
```python Python
from echowave_sdk import EchoWaveClient, Workflow
...
import { EchoWaveClient, Workflow } from "@echowave/sdk";
