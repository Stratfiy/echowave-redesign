...
- **Option 2**: For remote server deployment with HTTPS (using IP address). If you also have a custom domain, you can first deploy Decibyl stack on your server using steps in this document and then proceed to the [Custom Domain](custom-domain) section.
