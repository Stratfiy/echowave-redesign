...
#   filename:  decibyl-openapi-7cmOEN.json
#   timestamp: 2026-09-09T18:46:30+00:00
...
class CallOutcome(BaseModel):
    ...
    code: Annotated[str | None, Field(max_length=40, title='Code')] = ''
    label: Annotated[str | None, Field(max_length=60, title='Label')] = ''
    when: Annotated[str | None, Field(max_length=200, title='When')] = ''
...
class ContactListResponse(BaseModel):
    ...
    description: Annotated[str | None, Field(title='Description')] = None
    contact_count: Annotated[int | None, Field(title='Contact Count')] = 0
...
class DocumentResponseSchema(BaseModel):
    ...
    needs_reingest: Annotated[bool | None, Field(title='Needs Reingest')] = False
...
class FallbackServiceConfiguration(BaseModel):
    ...
    voice: Annotated[str | None, Field(title='Voice')] = ''
...
class LibraryExtraction(BaseModel):
    ...
    """
    answer_type: Annotated[str | None, Field(title='Answer Type')] = 'free_text'
    predefined_options: Annotated[str | None, Field(title='Predefined Options')] = ''
    expected_format: Annotated[str | None, Field(title='Expected Format')] = 'text'
...
class LibraryToolParameter(BaseModel):
    ...
    name: Annotated[str, Field(title='Name')]
    type: Annotated[str | None, Field(title='Type')] = 'string'
...
class WorkflowConfigurationDefaults(BaseModel):
    ...
    user_speech_timeout: Annotated[
        float | None, Field(ge=0.15, le=3.0, title='User Speech Timeout')
    ] = 0.4
    dictionary: Annotated[str | None, Field(title='Dictionary')] = ''
    interruption_backoff_secs: Annotated[
        float | None, Field(ge=0.0, le=3.0, title='Interruption Backoff Secs')
    ] = 0.0
    context_compaction_enabled: Annotated[
        bool | None, Field(title='Context Compaction Enabled')
    ] = False
    fallback_tts: Annotated[
        list[FallbackServiceConfiguration] | None,
        Field(max_length=2, title='Fallback Tts'),
    ] = None
    fallback_stt: Annotated[
        list[FallbackServiceConfiguration] | None,
        Field(max_length=2, title='Fallback Stt'),
    ] = None
    call_outcomes: Annotated[
        list[CallOutcome] | None, Field(max_length=30, title='Call Outcomes')
    ] = None
    follow_caller_language: Annotated[
        bool | None, Field(title='Follow Caller Language')
    ] = False
    accept_keypad_input: Annotated[bool | None, Field(title='Accept Keypad Input')] = (
        False
    )
    speak_like_callers: Annotated[bool | None, Field(title='Speak Like Callers')] = (
        False
    )
...
class WorkflowListResponse(BaseModel):
    ...
    name: Annotated[str, Field(title='Name')]
    status: Annotated[str, Field(title='Status')]
    is_live: Annotated[bool | None, Field(title='Is Live')] = True
    created_at: Annotated[AwareDatetime, Field(title='Created At')]
...
class ExtractionLibraryResponse(BaseModel):
    ...
    extractions: Annotated[list[LibraryExtraction], Field(title='Extractions')]
...
class LibraryTool(BaseModel):
    ...
    tool_description: Annotated[str, Field(title='Tool Description')]
    method: Annotated[str | None, Field(title='Method')] = 'GET'
    url: Annotated[str, Field(title='Url')]
    parameters: Annotated[
        list[LibraryToolParameter] | None, Field(title='Parameters')
    ] = None
    setup_note: Annotated[str | None, Field(title='Setup Note')] = ''
...
class ToolLibraryResponse(BaseModel):
    catalog: Annotated[str, Field(title='Catalog')]
    vendors: Annotated[list[str], Field(title='Vendors')]
    tools: Annotated[list[LibraryTool], Field(title='Tools')]
